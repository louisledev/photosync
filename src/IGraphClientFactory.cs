...
namespace PhotoSync
{
    ...
    public interface IGraphClientFactory
    {
        ...
        /// <param name="clientSecretName">Optional name of the Key Vault secret containing the client secret. If not provided, uses configuration or default.</param>
        /// <returns>Configured GraphServiceClient</returns>
        GraphServiceClient CreateClient(string clientId, string tenantId, string refreshTokenSecretName, string? clientSecretName = null);
